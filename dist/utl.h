...
#define logwatch(...)  for (log_watch_t utl_log_watch_= {.prev = utl_log_watch, .watch = {__VA_ARGS__,"\1"}, .flg = 0}; \
                                 (utl_log_watch = &utl_log_watch_),((utl_log_watch_.flg) \
                                                                           ? ((utl_log_watch = utl_log_watch->prev), 0)  \
                                                                           : (utl_log_prt("WCH START\x09:%s:%d\x09",__FILE__,__LINE__), 1)); \
                                 utl_log_watch_last(utl_log_watch,__FILE__,__LINE__),\
                                 utl_log_prt("WCH END\x09:%s:%d\x09",__FILE__,__LINE__),utl_log_watch_.flg = 1)
